                ...
                <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <x-text-input type="email" id="email" placeholder="{{ __('Saisir votre email') }}" name="email"
                        ...
                        <div class="mb-6">
                            <div class="flex justify-between">
                                ...
                                <a href="{{ route('password.request') }}" class="mt-3 text-xs text-gray-500">{{ __('Forgot your password?') }}</a>
                            </div>
                            <div class="relative">
                                <x-text-input type="password" id="password" name="password" autocomplete="current-password"
