                ...
                <div class="card rounded-3">
                    ...
                    <div class="p-0 card-header">
                        <div>
                            ...
                            <ul class="nav nav-lb-tab border-bottom-0" id="tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active position-relative" id="exercice-tab" data-bs-toggle="pill"
                                        href="#exercice" role="tab" aria-controls="exercice" aria-selected="true">Tous
                                        <span
                    ...
                    <div>
                        ...
                        <div class="tab-content" id="tabContent">
                            @include('livewire.reponses.exercices.listes')
                            @include('livewire.reponses.exercices.archives')
                        </div>
                    </div>
                    <!-- Card Footer -->
