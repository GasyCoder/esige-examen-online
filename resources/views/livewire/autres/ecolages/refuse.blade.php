<div class="tab-pane fade" id="cancelled" role="tabpanel" aria-labelledby="cancelled-tab">
    <div class="table-responsive">
        ...
        <table class="table mb-0 text-nowrap table-hover table-centered table-with-checkbox">
            ...
            <tbody>
                <!-- Table body -->
                @foreach($ecolagesCancel as $ecolage)
                @php
                ...
                <tr>
                    ...
                    {{--<td><span class="badge bg-info-soft">{{ number_format($amountCancel[$ecolage->id], 2) }} Ar</span>
                    </td>
                    ...
                    <td>
                        <span class="dropdown dropstart">
                            ...
                            <span class="dropdown-menu" aria-labelledby="orderDropdownOne"
                                ...
                                <a class="dropdown-item text-success" href="#!" wire:click="payRecover({{ $ecolage->id }})">
        ...
        @else
        <p class="mt-4 text-center text-danger">Aucun paiement annulée ici.</p>
        @endif
    </div>
</div>