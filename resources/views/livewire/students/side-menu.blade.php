    ...
    <div class="collapse navbar-collapse" id="sidenav">
        <div class="navbar-nav flex-column">
            ...
            <ul class="mb-4 list-unstyled ms-n2">
                ...
                <!-- Nav item -->
                <li class="nav-item @if(request()->routeIs('myprogramme')) active @endif">
                    <a class="nav-link" href="#">
                ...
                <!-- Nav item -->
                <li class="nav-item @if(request()->routeIs('myecolage')) active @endif">
                    <a class="nav-link" href="#">
                        <i class="fe fe-credit-card nav-icon"></i>
                        Ecolage
                    </a>
                </li>
                @elseif(Route::is('myprofile'))
                <!-- Nav item -->
                <li class="nav-item @if(request()->routeIs('myprofile')) active @endif">
                    <a class="nav-link" href="#">
